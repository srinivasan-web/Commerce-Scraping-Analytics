...
def export_excel(products: list[Product]) -> bytes:
    ...
    demand = variants.sort_values("Sales Potential Score", ascending=False)
    ...
    with pd.ExcelWriter(output, engine="openpyxl") as writer:
        ...
        write_frame(writer, demand[["Parent ASIN", "Variant Name", "Trend Score", "Popularity Score", "Variant Monthly Units Sold", "Sales Potential Score"]], "Demand Analytics")
